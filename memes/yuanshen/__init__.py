...
def yuanshen(images: list[BuildImage], texts, args):
    ...
    user_locs = [
        (-60, 0,0,0),(106, 137,18,13), (114, 100,26,31), (94, 0,68,83), (79, -10,69,65), (87, 2,62,58),
    ...
    for i in range(36):
        ...
        # 复制头像并旋转
        head = user_head.copy().rotate(rotate_num[i], expand=True)

        # 取坐标
        x, y, w, h = user_locs[i]

        # 贴到对应位置
        frame.paste(head, (x, y), alpha=True, below=True)
