...
def caosini(images: list[BuildImage], texts, args):
    try:
        if not images:
            raise ValueError("No images provided")
        img = images[0].convert("RGBA").resize((85, 90))  # 获取用户头像

        # 帧位置定义
        head_locs = [
            (68, 169), (68, 172), (151, 191), (164, 146), (178, 131), (98, 222), 
            (98, 224), (83, 145), (83, 145)
        ]
